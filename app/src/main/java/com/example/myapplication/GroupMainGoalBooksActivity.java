...
public class GroupMainGoalBooksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notificationButton1.setOnClickListener(v -> {
            Intent i = new Intent(GroupMainGoalBooksActivity.this, GroupMemberActivity.class);
            i.putExtra("groupId", groupId);
            startActivity(i);
        });
        notificationButton2.setOnClickListener(v ->
                startActivity(new Intent(GroupMainGoalBooksActivity.this, GroupCommunityActivity.class))
        );
        notificationButton3.setOnClickListener(v ->
                startActivity(new Intent(GroupMainGoalBooksActivity.this, AlarmPageActivity.class))
        );
