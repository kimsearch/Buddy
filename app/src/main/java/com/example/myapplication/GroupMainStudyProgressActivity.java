...
public class GroupMainStudyProgressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.group_main_study_progress);
        ...
        notificationButton1.setOnClickListener(v -> {
            Intent i = new Intent(GroupMainStudyProgressActivity.this, GroupMemberActivity.class);
            i.putExtra("groupId", groupId);
            startActivity(i);
        });
        notificationButton2.setOnClickListener(v ->
                startActivity(new Intent(GroupMainStudyProgressActivity.this, GroupCommunityActivity.class))
        );
        notificationButton3.setOnClickListener(v ->
                startActivity(new Intent(GroupMainStudyProgressActivity.this, AlarmPageActivity.class))
        );
