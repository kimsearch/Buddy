...
public class GroupMainGoalScoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.group_main_goal_score);
        ...
        notificationButton1.setOnClickListener(v -> {
            Intent i = new Intent(GroupMainGoalScoreActivity.this, GroupMemberActivity.class);
            i.putExtra("groupId", groupId);
            startActivity(i);
        });
        notificationButton2.setOnClickListener(v ->
                startActivity(new Intent(GroupMainGoalScoreActivity.this, GroupCommunityActivity.class))
        );
        notificationButton3.setOnClickListener(v ->
                startActivity(new Intent(GroupMainGoalScoreActivity.this, AlarmPageActivity.class))
        );
