...
public class MyPageMainActivity extends AppCompatActivity {
    ...
    private void drawMonthlyChart() {
        ...
        // 예시 구조: List<Entry> personalEntries = getPersonalDataFromDB();
        // 예시 구조: List<Entry> groupEntries = getGroupDataFromDB();

        List<Entry> personalEntries = new ArrayList<>();
        List<Entry> groupEntries = new ArrayList<>();

        //DB 연동
        // 예시: personalEntries.add(new Entry(0, 70)); // 0 = 1월
        // 예시: groupEntries.add(new Entry(0, 60));
