...
public class GroupMainTimeLogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notificationButton1.setOnClickListener(v -> {
            Intent i = new Intent(GroupMainTimeLogActivity.this, GroupMemberActivity.class);
            i.putExtra("groupId", groupId);
            startActivity(i);
        });
        notificationButton2.setOnClickListener(v ->
                startActivity(new Intent(GroupMainTimeLogActivity.this, GroupCommunityActivity.class))
        );
        notificationButton3.setOnClickListener(v ->
                startActivity(new Intent(GroupMainTimeLogActivity.this, AlarmPageActivity.class))
        );
