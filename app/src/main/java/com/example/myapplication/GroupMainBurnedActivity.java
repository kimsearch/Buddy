...
public class GroupMainBurnedActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navSearch.setOnClickListener(v -> startActivity(new Intent(GroupMainBurnedActivity.this, GroupSearchPageActivity.class)));
        navPet.setOnClickListener(v -> startActivity(new Intent(GroupMainBurnedActivity.this, PetActivity.class)));
    }
